...
const ControlsPanel: React.FC<ControlsPanelProps> = ({
  ...
  return (
    <Card className="fixed bottom-4 left-1/2 transform -translate-x-1/2 w-[calc(100%-2rem)] max-w-4xl shadow-2xl border-border bg-card/90 backdrop-blur-sm z-50">
        ...
        <AccordionItem value="controls-panel" className="border-b-0">
          ...
          <AccordionContent className="p-4 pt-0">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div>
                <Label htmlFor="presetSelect" className="text-sm font-medium">Preset</Label>
              ...
              <TabsContent value="smoke">
                ...
                {isSmokeEnabled && (
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                        <Input id="smokeBaseColor" type="color" value={smokeBaseColor} onChange={(e) => setSmokeBaseColor(e.target.value)} className="p-1 h-10 w-14" />
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                        <Input id="smokeAccentColor" type="color" value={smokeAccentColor} onChange={(e) => setSmokeAccentColor(e.target.value)} className="p-1 h-10 w-14" />
                ...
                {isFireEnabled && (
                    ...
                    <div>
                        <Label htmlFor="fireBaseColor" className="text-sm font-medium">Base Color</Label>
                         <div className="flex items-center gap-2">
                            <Input id="fireBaseColor" type="color" value={fireBaseColor} onChange={(e) => setFireBaseColor(e.target.value)} className="p-1 h-10 w-14" />
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            <Input id="fireAccentColor" type="color" value={fireAccentColor} onChange={(e) => setFireAccentColor(e.target.value)} className="p-1 h-10 w-14" />
